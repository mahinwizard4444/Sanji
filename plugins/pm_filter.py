...
from database.connections_mdb import active_connection, all_connections, delete_connection, if_active, make_active, \
    make_inactive
from info import ADMINS, AUTH_CHANNEL, CUSTOM_FILE_CAPTION, REQ_CHANNEL, AUTH_CHATS
...
@Client.on_message(filters.group & filters.text & filters.incoming & filters.chat(AUTH_CHATS) if AUTH_CHATS else filters.group & filters.text & filters.incoming)
