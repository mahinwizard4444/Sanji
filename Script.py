...
- Filter is the feature were users can set automated replies for a particular keyword and Tokyo will respond whenever a keyword is found the message
...
2. Tokyo supports buttons with any telegram media type.
